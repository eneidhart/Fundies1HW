...
(define (move-down tetra)
  (make-tetra (make-posn 
              ...
              (move-down-help (tetra-blocks tetra))
              (tetra-ghost tetra)))

;; TODO: Map will probably work well here
;; Helper function for move-down.
;; Moves a BSet down by one grid-unit.
;; BSet -> BSet
(define (move-down-help blocks)
  (local [(define (make-moved block)
            (make-block (block-x block)
                        (+ (block-y block) GRID-SIZE)
                        (block-color block)))]
    (map make-moved blocks)))
#|(cond[(cons? blocks) 
...
;; TODO: append probably works best here
...
;; TODO: ormap is probably best here
...
;; TODO: Map will probably work best here
...
;; TODO: map is probably best here
...
;; TODO: ormap will probably work best here
